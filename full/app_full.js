$(window).load(function() {
    ...
    // } else { // Otherwise show...
        ...
        $("#spacecraft img").delay(2000).fadeIn(3000)
    // }
    ...
    document.getElementById("closeSuggestion").addEventListener('click', function(){
        $("#animationResp").attr("style", "display:none")
        $("#coverBack").attr("style", "display:none")

        localStorage.setItem("resp","none")
       })
